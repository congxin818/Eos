...
async function selectOverviewByTimesAndLinebodys(req , res , next){
   ...
   // console.log("---Ids.length--->"+JSON.stringify(Ids.length));
    ...
    //console.log("---req.body.startTime--->"+JSON.stringify(req.body.startTime));
    const data = await this.selectBarchartByTimesAndLinebodys(req.body.startTime , req.body.endTime , Ids , userId);
...
/*
    ...
    */
async function selectBarchartByTimesAndLinebodys(startTime , endTime , Ids , userId){
